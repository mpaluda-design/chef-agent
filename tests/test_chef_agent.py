...
from tools import search_healthy_recipes, verify_nutritional_compliance, optimize_pantry_shopping_list
...
class TestChefAgentRubricEvaluation(unittest.TestCase):
    ...
    def setUp(self):
        self.prefs = UserPreferences(
            ...
            pantry_inventory=["greek yogurt 0%", "chia seeds", "olive oil", "cinnamon"],
        )
    ...
    def test_history_compaction_sliding_window(self):
        ...
        for i in range(15):
            coord.conversation_history.append({"turn": i, "content": "test meal discussion"})
    ...
    def test_allergen_policy_guardrail_hard_stop(self):
        ...
        audit = nutritionist.audit_daily_plan(dummy_plan, prefs_with_shrimp_allergy, logger, span)
    ...
    def test_pii_redaction(self):
        ...
        raw_text = "Contact user at john.doe@google.com or call 555-123-4567 for meal pickup."
